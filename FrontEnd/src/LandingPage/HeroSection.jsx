    ...
    <div className="flex flex-col-reverse md:flex-row px-4 md:px-12 mt-8  z-0 ">
      <div className="flex flex-col justify-center items-center md:items-start w-full sm:w-3/4 md:px-12 pt-2 md:pt-10 mt-10 md:mt-0 ">
        ...
        <div className="flex flex-col md:flex-row gap-2 justify-center md:justify-start">
          <button className="py-1 border mt-2 bg-red-700 text-white font-bold text-center px-3 rounded-md" onClick={goToSearchBook}>
            Get Started
          </button>
          <button className="py-1 border mt-2 hover:bg-red-700 hover:text-white text-black font-bold text-center px-4 rounded-md" onClick={gotoAboutUs}>
            About Us
          </button>
        </div>
      </div>
