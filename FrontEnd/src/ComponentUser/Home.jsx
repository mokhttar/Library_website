      ...
      >
        <ScrollContext.Provider value={{ gotoAboutUs, goToSearchBook }}>
          <ParallaxLayer offset={0} speed={0} factor={1}>
            ...
            <ParallaxLayer
              offset={width < 500 && height < 700 ? 1.5 : 1}
              speed={0.4}
              factor={1}
              className=""
            >
            ...
            <ParallaxLayer
              offset={width < 500 && height < 700 ? 2.2 : 1.999}
              speed={1}
              factor={1}
            >
              <div className="relative flex items-center justify-center h-screen mt-2    ">
                ...
                <div className="absolute flex flex-col mt-10 justify-center  items-center sm:justify-start sm:items-start   sm:top-10 top-2 px-4  text-white">
                  <div className="text-start bg-opacity-80 bg-black sm:w-1/2 px-5 rounded-xl py-2 opacity-95">
                    ...
                    <p className="pb-2 tracking-wide py-3  text-white">
                      ...
                      empruntez-les en ligne en seulement quelques clics. Que
                      vous soyez passionné par les classiques intemporels ou
                      curieux des dernières avancées en recherche, notre
                      bibliothèque virtuelle a tout ce qu'il vous faut pour
                      exceller dans vos études et élargir vos horizons
                      intellectuels. Rejoignez-nous dès maintenant pour enrichir
                      votre esprit, découvrir de nouveaux horizons et nourrir
                      votre soif de savoir. Que l'aventure de la connaissance
                  ...
                  <div className="bg-black  bg-opacity-70   mt-4 hidden sm:block  p-4 rounded-lg sm:hidden text-white">
                    ...
                    Explore a world of knowledge and enrichment at the
                    University of Setif 1 library's diverse events. From
                    lectures to book clubs, our events offer learning,
                    networking, and cultural engagement opportunities. Join us
                    in exploring new ideas and expanding your horizons!.
                  </div>
                </div>
                ...
                <div className="absolute inset-0 mt-12 sm:justify-end px-2 top-10 sm:items-start   ml-24  hidden sm:flex">
                  <div className="bg-black  bg-opacity-70 w-1/2 pb-20 pt-20  mt-8  px-4 mr-5 rounded-lg text-white">
                    ...
                    Discover a world of knowledge and enrichment at the
                    University of Setif 1 library's events. Our library hosts a
                    diverse range of events throughout the year, offering unique
                    opportunities for learning, networking, and cultural
                    engagement. From informative lectures and workshops to book
                    clubs and author talks, our events cater to various
                    interests and disciplines. Whether you're a student, faculty
                    member, or a curious community member, you'll find something
                    exciting and enriching to participate in. Stay updated with
                    our upcoming events schedule to make the most out of your
                    library experience. Join us in exploring new ideas,
                    fostering intellectual discussions, and expanding your
                    horizons at the University of Setif 1 library.
                  </div>
                </div>
              </div>
            </ParallaxLayer>
