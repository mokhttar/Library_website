...
function NavBare()
{
    ...
    return(
        <>
        <nav>        
     <div className="px-2 mt-2 flex relative border-b-2 py-1 shadow-md "> 
    ...
    <ul className="pt-3">
        ...
        <div className="sm:mt-4 sm:absolute sm:right-0  sm:flex sm:gap-6 flex  absolute right-0 mt-2 gap-3">
             <img src={NotifiLogo} alt="Notification-logo" className="" />
            <img src={CartLogo} alt="Cart-logo" className="h-6 mt-1" />
      <Link to='/Login'><button className=" border-none px-4  mr-3 h-8 rounded-lg border-bg-red bg-[#B80000]  text-white cursor-pointer tracking-wide">Login</button></Link>
